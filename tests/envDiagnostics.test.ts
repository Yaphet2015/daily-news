...
test('buildEnvironmentFingerprint captures runtime, env, command paths, parent, and data files', async () => {
  const fingerprint = await buildEnvironmentFingerprint({
    ...
    env: {
      ...
      ENABLE_TWITTER_RECOMMENDATIONS: 'true',
      TWITTER_RECOMMENDATION_CDP_ENDPOINT: 'http://127.0.0.1:9222',
      TWITTER_RECOMMENDATION_BATCH_SIZE: '50',
      TWITTER_RECOMMENDATION_BATCH_COUNT: '6',
      TWITTER_RECOMMENDATION_BATCH_MIN_DELAY_MS: '8000',
      TWITTER_RECOMMENDATION_BATCH_MAX_DELAY_MS: '20000',
