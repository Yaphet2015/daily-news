...
const DIAGNOSTIC_ENV_KEYS = [
  ...
  'TWITTER_PROXY',
  'ENABLED_SOURCES',
  'ENABLE_TWITTER_RECOMMENDATIONS',
  'TWITTER_RECOMMENDATION_CDP_ENDPOINT',
  'TWITTER_RECOMMENDATION_BATCH_SIZE',
  'TWITTER_RECOMMENDATION_BATCH_COUNT',
  'TWITTER_RECOMMENDATION_BATCH_MIN_DELAY_MS',
  'TWITTER_RECOMMENDATION_BATCH_MAX_DELAY_MS',
  'TERM_PROGRAM',
] as const;
